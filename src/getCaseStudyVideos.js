const getCaseStudyVideos = () => {
  const videos = [
    {
      id: "kbt3hk7eyp",
      title:
        "Presentation Design for CEO Buy‑In: Turning a Complex Algorithm into a Clear Story",
      desc: `My client needed to clearly explain a complex algorithm to their
    ...
    // },
    {
      ...
      desc: `For this end-of-year business unit presentation, my client
...
export default getCaseStudyVideos
